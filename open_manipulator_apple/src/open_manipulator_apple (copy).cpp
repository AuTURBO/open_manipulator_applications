...
int main(int argc, char **argv)
{
  ...
  OpenManipulatorPickandPlace open_manipulator_apple;

  ros::Timer publish_timer = node_handle.createTimer(ros::Duration(0.100)/*100ms*/, &OpenManipulatorPickandPlace::publishCallback, &open_manipulator_apple);
